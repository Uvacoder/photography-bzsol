            ...
            <div className="max-w-6xl px-5 mx-auto mt-32 text-center">
                ...
                <div className="flex flex-col mt-24 md:flex-row md:space-x-6">
                    <div className="flex flex-col items-center p-6 mt-16 space-y-6 rounded-bg bg-gray-100 md:w-1/3">
                        <img src="https://randomuser.me/api/portraits/women/17.jpg" className="w-16 -mt-14 rounded-full left-4" alt="" />
                    ...
                    <div className="flex flex-col items-center p-6 mt-16 space-y-6 rounded-bg bg-gray-100 md:w-1/3">
                        <img src="https://randomuser.me/api/portraits/men/10.jpg" className="w-16 -mt-14 rounded-full left-4" alt="" />
                    ...
                    <div className="flex flex-col items-center p-6 space-y-6 mt-16 rounded-bg bg-gray-100 md:w-1/3">
                        <img src="https://randomuser.me/api/portraits/women/32.jpg" className="w-16 -mt-14 rounded-full left-4" alt="" />

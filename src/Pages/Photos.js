...
function Photos() {
  ...
  return (
    ...
    <div className='text-center'>
      ...
      <h1 className='flex flex-col md:flex-row text-4xl md:text-6xl justify-center text-slate-700 opacity-85  font-semibold mt-32 mb-32'>Milyen témákban vállalok fotózást?</h1>

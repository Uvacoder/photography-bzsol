            ...
            <div className="container flex flex-col md:flex-row items-center px-6 mx-auto mt-2 space-y-0 md:space-y-0 p-12">
                <div className="container mx-10 md:mx-96 my-40 p-6 max-w-md bg-white rounded-lg border border-gray-200 shadow-2xl w-4/5 md:w-1/2 ">
                    <form className="flex flex-col">
                        ...
                        <button type="submit" className="relative text-center  mt-10 bg-sky-500 hover:bg-sky-600 focus:outline-none focus:ring focus:ring-sky-300 active:bg-sky-700 px-10 py-2 text-sm leading-5 rounded-lg font-semibold text-white "> Üzenet küldése</button>
                    </form>
                </div>
                <div className="flex flex-col items-center w-1/5  md:w-1/2 ">
                    <div className="flex flex-row ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" className="bi bi-facebook px-6 fill-sky-500 hover:fill-sky-600 focus:outline-none focus:ring focus:ring-sky-300 active:fill-sky-700 " viewBox="0 0 16 16">
                            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" className="bi bi-instagram px-6 fill-violet-500 hover:fill-violet-600 focus:outline-none focus:ring focus:ring-violet-300 active:fill-violet-700" viewBox="0 0 16 16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" className="bi bi-whatsapp px-6 fill-green-500 hover:fill-green-600 focus:outline-none focus:ring focus:ring-green-300 active:fill-green-700" viewBox="0 0 16 16">
                        ...
                        <button data-tooltip-target="tooltip-default" type="button">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-reddit  px-6 fill-orange-500 hover:fill-orange-600 focus:outline-none focus:ring focus:ring-orange-300 active:fill-orange-700" viewBox="0 0 16 16">

        ...
        <nav className="relative container mx-auto p-6">
            <div className="flex items-right justify-between">
                ...
                <div className="hidden md:flex space-x-6">
                    ...
                    <a href='/gallery'><button type="button" class="px-10 py-3 bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring focus:ring-orange-300 active:bg-orange-700  leading-5 rounded-lg font-medium text-white ">Galéria</button></a>
                </div>
            </div>
